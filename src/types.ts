...
export interface CardConfigEntities {
	...
	non_essential_load4: string;
	non_essential_load5: string;
	non_essential_load6: string;
	non_essential_load7: string;
	non_essential_load8: string;
	non_essential_load9: string;
	non_essential_load10: string;
	non_essential_load11: string;
	non_essential_load12: string;
	non_essential_load13: string;
	non_essential_load14: string;
	non_essential_load15: string;
	non_essential_load1_extra: string;
	non_essential_load2_extra: string;
	non_essential_load3_extra: string;
	non_essential_load4_extra: string;
	non_essential_load5_extra: string;
	non_essential_load6_extra: string;
	non_essential_load7_extra: string;
	non_essential_load8_extra: string;
	non_essential_load9_extra: string;
	non_essential_load10_extra: string;
	non_essential_load11_extra: string;
	non_essential_load12_extra: string;
	non_essential_load13_extra: string;
	non_essential_load14_extra: string;
	non_essential_load15_extra: string;
...
export interface DataDto {
	...
	stateNonEssentialLoad4Extra: CustomEntity;
	stateNonEssentialLoad5Extra: CustomEntity;
	stateNonEssentialLoad6Extra: CustomEntity;
	stateNonEssentialLoad7Extra: CustomEntity;
	stateNonEssentialLoad8Extra: CustomEntity;
	stateNonEssentialLoad9Extra: CustomEntity;
	stateNonEssentialLoad10Extra: CustomEntity;
	stateNonEssentialLoad11Extra: CustomEntity;
	stateNonEssentialLoad12Extra: CustomEntity;
	stateNonEssentialLoad13Extra: CustomEntity;
	stateNonEssentialLoad14Extra: CustomEntity;
	stateNonEssentialLoad15Extra: CustomEntity;
	...
	stateNonessentialLoad4: CustomEntity;
	stateNonessentialLoad5: CustomEntity;
	stateNonessentialLoad6: CustomEntity;
	stateNonessentialLoad7: CustomEntity;
	stateNonessentialLoad8: CustomEntity;
	stateNonessentialLoad9: CustomEntity;
	stateNonessentialLoad10: CustomEntity;
	stateNonessentialLoad11: CustomEntity;
	stateNonessentialLoad12: CustomEntity;
	stateNonessentialLoad13: CustomEntity;
	stateNonessentialLoad14: CustomEntity;
	stateNonessentialLoad15: CustomEntity;
